...
df_asc_des['asc_v'] = utils.proj_los_into_vertical_no_horiz(df_asc_des['asc_vel'], df_asc_des['asc_inc'])
df_asc_des['des_v'] = utils.proj_los_into_vertical_no_horiz(df_asc_des['des_vel'], df_asc_des['des_inc'])
...
des169_lon, des169_lat, des169_vel, des169_azi, des169_inc = utils.load_insar_vel_data_as_2Darrays(
    "/Volumes/WD2TB_Phd/NC_ALOS-2/Data_Zenodo/169/P345/geo/geo_geometryRadar.h5",
    "/Volumes/WD2TB_Phd/NC_ALOS-2/Data_Zenodo/169/P345/geo/geo_velocity_endDate20200101_ITRF14_msk_deramp.h5"
)
des170_lon, des170_lat, des170_vel, des170_azi, des170_inc = utils.load_insar_vel_data_as_2Darrays(
    "/Volumes/WD2TB_Phd/NC_ALOS-2/Data_Zenodo/170/P345/geo/geo_geometryRadar.h5",
    "/Volumes/WD2TB_Phd/NC_ALOS-2/Data_Zenodo/170/P345/geo/geo_velocity_endDate20200101_ITRF14_msk_deramp.h5"
)

track169grd = "/Volumes/WD2TB_Phd/NC_ALOS-2/Data_Zenodo/169/P345/geo/geo_velocity_endDate20200101_ITRF14_msk_deramp_mm.grd"
track170grd = "/Volumes/WD2TB_Phd/NC_ALOS-2/Data_Zenodo/170/P345/geo/geo_velocity_endDate20200101_ITRF14_msk_deramp_mm.grd"
diff_grd = "/Volumes/WD2TB_Phd/NC_ALOS-2/Data_Zenodo/170/P345/geo/diff_endDate20200101_ITRF14_msk_deramp_mm.grd"
...
with fig.subplot(nrows=1, ncols=4, figsize=("11c", "5.1c"), autolabel="d)", sharex="l", frame=["WSrt"], margins=["0.3c", "0.3c"]):
    ...
    fig.grdimage(grid=track169grd, cmap=True, region=[region_des], projection=map_size_des)
    fig.coast(shorelines=True, region=[region_des], projection=map_size_des, frame=["+t169: 2015-2019"])
    ...
    fig.basemap(frame=["wSrt", "xa", "ya"], region=region_des, projection=map_size_des, panel=True)
    pygmt.makecpt(cmap="vik", series=[vmin, vmax])
    fig.grdimage(grid=track170grd, cmap=True, region=[region_des], projection=map_size_des)
    fig.coast(shorelines=True, region=[region_des], projection=map_size_des, frame=["+t170: 2015-2019"])
    fig.plot(y=ref_lat, x=ref_lon, style="s.1c", fill="black", pen="0.8p,black", region=[region_des], projection=map_size_des,)
    ...
    fig.basemap(frame=["wSrt", "xa", "ya"], region=region_des, projection=map_size_des, panel=True)
    pygmt.makecpt(cmap="vik", series=[vmin, vmax])
    fig.grdimage(grid=diff_grd, cmap=True, region=[region_des], projection=map_size_des)
    ...
    fig.plot(x=[-5,3.5], y=[-5,3.5], pen="0.5p,black", region=vel_region_des, projection=scatter_size_des)
...
fig.savefig(common_paths["fig_dir"]+f'Fig_7_insar_insar_validation_{ref_station}_2015-2019.png', transparent=False, crop=True, anti_alias=True, show=False)
#fig.savefig(common_paths["fig_dir"]+f'Fig_7_insar_insar_validation_{ref_station}_2015-2024.pdf', transparent=False, crop=True, anti_alias=True, show=False)
fig.savefig(common_paths["fig_dir"]+f'Fig_7_insar_insar_validation_{ref_station}_2015-2019.jpg', dpi=600, transparent=False, crop=True, anti_alias=True, show=False)
fig.show()