...
fig.savefig(common_paths["fig_dir"]+f'Fig_7_insar_insar_validation_{ref_station}_2015-2024.png', transparent=False, crop=True, anti_alias=True, show=False)
...
fig.savefig(common_paths["fig_dir"]+f'Fig_7_insar_insar_validation_{ref_station}_2015-2024.jpg', dpi=600, transparent=False, crop=True, anti_alias=True, show=False)
fig.show()