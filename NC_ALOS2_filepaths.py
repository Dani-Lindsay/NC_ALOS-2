...
data_dir = "/Volumes/WD2TB_Phd/NC_ALOS-2/Data"
gps_dir = "/Volumes/WD2TB_Phd/NC_ALOS-2/Data/GPS"
...
paths_068 = {
    ...
    "coherence" : os.path.join(data_dir, "068", "coherenceSpatialAvg.txt"),
    "CASR": {
...
paths_169 = {
    ...
    "coherence" : os.path.join(data_dir, "169", "coherenceSpatialAvg.txt"),
    "CASR": {
...
paths_170 = {
    ...
    "coherence" : os.path.join(data_dir, "170", "coherenceSpatialAvg.txt"),
    "CASR": {
