...
with fig.subplot(nrows=2, ncols=1, figsize=("8c", "5.4c"), autolabel="e)", sharex="b", frame=["lSEt" , "xaf+l Profile Distance (km)", "ya+l LOS (mm/yr)"],
    ...
    fig.plot(x=gps_ts_115["ts_date"], y=gps_ts_115["insar_LOS_baseline_115"]*unit, style="c0.1c", fill="navy", label=f"S1 RMSE {np.round(rmse_metrics['track115']['LOS']*unit, 2)} cm")
    fig.plot(x=gps_ts_170["ts_date"], y=gps_ts_170["insar_LOS_baseline_170"]*unit, style="c0.1c", fill="orangered", label=f"A2 RMSE {np.round(rmse_metrics['track170']['LOS']*unit, 2)} cm") 
    ...
    fig.plot(x=gps_ts_115["ts_date"], y=gps_ts_115["insar_Up_baseline_115"]*unit, style="c0.1c", fill="navy", label=f"S1 RMSE {np.round(rmse_metrics['track115']['Up']*unit, 2)} cm")
    fig.plot(x=gps_ts_170["ts_date"], y=gps_ts_170["insar_Up_baseline_170"]*unit, style="c0.1c", fill="orangered", label=f"A2 RMSE {np.round(rmse_metrics['track170']['LOS']*unit, 2)} cm")  
